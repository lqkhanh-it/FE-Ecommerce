...
export default function DashboardTodoList(props) {
  ...
  useEffect(() => {
    axios.get(`https://be-ecommerce-year4.herokuapp.com/todos`).then((res) => {
  ...
  const clickToCheck = (event) => {
    ...
    axios.post("https://be-ecommerce-year4.herokuapp.com/todos/update", {
      id: id,
      isDone: isDone,
    });
  };
  ...
  const addNewTodo = (event) => {
    ...
    axios
      .post("https://be-ecommerce-year4.herokuapp.com/todos", data)
      .then((res) => {
        axios
          .get(`https://be-ecommerce-year4.herokuapp.com/todos`)
          .then((res2) => {
  ...
  const deleteTodo = (event) => {
    ...
    axios
      .post("https://be-ecommerce-year4.herokuapp.com/todos", {
        delete: true,
        id: id,
      })
      .then((res) => {
